...
/**
 * For fully module free icon pack registration, without the need to import `NbIconModule` into the app module,
 * you can use `provideNbEssentialIcons` function in your app providers.
 * @returns EnvironmentProviders
 */
export function provideNbEssentialIcons(): EnvironmentProviders {
  return makeEnvironmentProviders([
    {
      provide: NbIconLibraries,
      useFactory: () => {
        const iconsLibrary = new NbIconLibraries();
        const essentialsPackName = 'nebular-essentials';

        if (!iconsLibrary.getPack(essentialsPackName)) {
          iconsLibrary.registerSvgPack(essentialsPackName, ESSENTIAL_ICONS);
        }
        return iconsLibrary;
      },
    },
...
export class NbIconModule {
  ...
  constructor(private iconsLibrary: NbIconLibraries) {
    ...
    this.iconsLibrary.registerSvgPack(this.essentialsPackName, ESSENTIAL_ICONS);
  }
}
